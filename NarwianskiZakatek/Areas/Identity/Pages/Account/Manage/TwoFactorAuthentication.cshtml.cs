...
namespace NarwianskiZakatek.Areas.Identity.Pages.Account.Manage
{
    public class TwoFactorAuthenticationModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "Obecna przeglądarka została zapomniana. Kiedy ponownie zalogujesz się z tej przeglądarki, zostaniesz poproszony/a o podanie kodu uwierzytelniającego z aplikacji.";
